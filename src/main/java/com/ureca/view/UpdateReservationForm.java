...
public class UpdateReservationForm {
    ...
    private Room_history originalHistory; // 수정할 원본 예약
    private User currentUser;
    private StudyCafeService service;
    private Runnable onSuccess; // 수정 후 목록 갱신용 콜백
    ...
    public UpdateReservationForm(User currentUser, Room_history history,
        ...
        // 처음 뜰 때 기존 예약 시간 미리 선택
        dateBt.addActionListener(e -> showTimeButtons());
    ...
    private void showTimeButtons() {
        ...
        // TODO: 실제 예약된 시간 가져오기 (service.getBookedHours())
        ...
        for (int hour = 9; hour < 22; hour++) {
            ...
            if (bookedHours.contains(hour) &&
                (hour < originalStart || hour >= originalEnd)) {
